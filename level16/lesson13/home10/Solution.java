...
public class Solution {
    ...
    static {
        try //в статическом блоке инициализируем пути к файлам
        {
    ...
    public static void systemOutPrintln(String fileName) throws InterruptedException {
        ...
        f.start();
        f.join(); //ждем когда дочитает один из потоков
    ...
    public static class ReadFileThread extends Thread implements ReadFileInterface {
        ...
        {
            String s = fileContent.toString().trim(); //обрезаем лишние пробелы
            return s + " ";
        }
        ...
        public void run()
        {
            ...
            {
                String str;
                while ((str = bufferedReader.readLine()) != null) { //файл читаем построчно
