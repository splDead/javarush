...
public class Solution {
    ...
    /**
     * Побитовое сравнение суммы всех модификаторов (allModifiers) с конкретным (specificModifier).
     * Результат будет true, если specificModifier входит в сумму allModifiers.
     * @param allModifiers
     * @param specificModifier
     * @return
     */
